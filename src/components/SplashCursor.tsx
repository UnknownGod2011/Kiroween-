...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    class PointerPrototypeClass implements PointerPrototype {
      id = -1;
      texcoordX = 0;
      texcoordY = 0;
      prevTexcoordX = 0;
    ...
    let pointers: PointerPrototype[] = [new PointerPrototypeClass()];
    ...
    function supportRenderTextureFormat(gl: any, internalFormat: any, format: any, type: any): boolean {
    ...
    window.addEventListener('mousemove', e => {
      const now = Date.now();
      // Throttle mouse move to every 16ms (60fps max)
